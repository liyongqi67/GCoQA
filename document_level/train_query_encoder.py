...
parser.add_argument("--test_file", default="/home/v-yongqili/project/GCoQA/data/QA_pairs/topiocqa/topiocqa_test.json",
                    type=str, required=False,
                    help="test_file ")
parser.add_argument("--corpus_path", default="/home/v-yongqili/project/GCoQA/data/full_wiki_document.json",
                    type=str, required=False,
                    help="dev_file ")
parser.add_argument("--trie_dict", default="/home/v-yongqili/project/GCoQA/data/trie_dict_t5-base_page_level.pkl",
                    type=str, required=False,
                    help="dev_file ")
